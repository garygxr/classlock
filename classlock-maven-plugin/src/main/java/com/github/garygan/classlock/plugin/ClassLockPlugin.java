package com.github.garygan.classlock.plugin;

import com.github.garygan.classlock.Const;
import com.github.garygan.classlock.JarEncryptor;
import com.github.garygan.classlock.util.StrUtils;
 ...
 * @author garygan
 */
@Mojo(name = "classLock", defaultPhase = LifecyclePhase.PACKAGE)
public class ClassLockPlugin extends AbstractMojo {
