...
import com.github.garygan.classlock.util.*;
import com.github.garygan.classlock.util.*;
 ...
 * 启动2 java -jar this.jar -file springboot.jar -libjars a.jar,b.jar -packages com.github.garygan,yiyon.com -exclude org.spring -pwd 995800 -Y
 *
 * @author garygan
 */
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //test数据
        if ("1".equals(path)) {
            path = "/Users/garygan/fsdownload/yiyon-package-liuyuan-1.0.0.jar";
            libjars = "yiyon-*.jar,aspectjweaver-1.8.13.jar,a.jar";
            packages = "com.yiyon,com.github.garygan.*";//包名过滤
            excludeClass = "org.spring.*";//排除的类
            password = "123456";
            classpath = "/Users/garygan/code-space/apache-tomcat-8.5.32/lib";
            cfgfiles = "*.yml";
            Const.DEBUG = false;
        } else if ("2".equals(path)) {
            path = "/Users/garygan/code-space/pig_project/target/pig_project_maven.war";
            packages = "com.github.garygan";//包名过滤
            excludeClass = "org.spring";//排除的类
            password = "#";
            classpath = "/Users/garygan/code-space/apache-tomcat-8.5.32/lib";
            Const.DEBUG = true;
        } else if ("3".equals(path)) {
            path = "/Users/garygan/Desktop/iyun.node.dicomserver.jar";
    ...
    public static void makeCode() {
        ...
        File file = new File(path, "classlock-code.txt");
