package com.github.garygan.classlock.util;

import java.io.File;

public class HtmlUtils {
    public static void main(String[] args) throws Exception {
        String txt = IoUtils.readTxtFile(new File("/Users/garygan/work-yiyon/易用框架/yiyon-framework/jeee-importer/src/main/resources/templates/importer-upload-form-pro.ftl"));
